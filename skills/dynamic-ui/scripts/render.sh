...
# Render with headless chromium instead of wkhtmltoimage
/snap/bin/chromium \
    --headless \
    --disable-gpu \
    --screenshot="/home/tre/rendered.png" \
    --window-size="$WIDTH",800 \
    "$TEMP_DIR/render.html"

# Move from home dir to final output
mv /home/tre/rendered.png "$OUTPUT_FILE"
